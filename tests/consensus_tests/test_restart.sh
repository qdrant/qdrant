...
poetry run ./create_collection_and_check.py test_collection 6433 6333 6533
poetry run ./insert_points.py test_collection 6333
poetry run ./check_points.py test_collection 6433 6333
...
poetry run ./create_collection_and_check.py test_collection_1 6433 6333 6533
...
poetry run ./downscale_cluster.py test_collection 6433 6333 6533

# Check points after downscale
poetry run ./check_points.py test_collection 6333
