...
def test_search_matrix_offsets(collection_name):
    ...
    expected_result = {
        ...
        'scores': [1.4063001, 1.2531, 1.155, 1.1359, 1.4063001, 1.2218001, 1.2531, 1.2218001, 0.7024, 0.6146, 0.6353, 0.5093, 1.0990001, 1.0349001, 1.1359, 1.0553],
        'ids': [1, 2, 3, 4, 5, 6, 7, 8]
    }
    assert search_result == expected_result
