...
impl<const BITS: usize> Query1bitSimd<BITS> {
    ...
    #[inline]
    pub fn tail_block_scratch(&self, vector: &[u8]) -> Option<([u8; BLOCK_BYTES], usize)> {
    ...
    #[inline]
    pub fn num_full_blocks(&self) -> usize {
...
/// the final rounding.
#[inline]
pub fn popcount_to_score(byte_len: usize, popcnt: u64) -> f32 {
