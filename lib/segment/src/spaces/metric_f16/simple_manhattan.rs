...
mod tests {
    ...
    #[test]
    fn test_property_zero_padding_manhattan_f16() {
        ...
        for &dim in &thresholds {
            ...
            let score1_orig = ManhattanMetric::similarity(&q, &p1);
            let score2_orig = ManhattanMetric::similarity(&q, &p2);
            ...
            let score1_pad = ManhattanMetric::similarity(&q_pad, &p1_pad);
            let score2_pad = ManhattanMetric::similarity(&q_pad, &p2_pad);
