...
fn get_match_value_checker(
    ...
    match (value_variant, index) {
        ...
        (ValueVariants::Bool(is_true), FieldIndex::BooleanIndex(index)) => {
            Some(Box::new(move |point_id: PointOffsetType| {
                if is_true {
        ...
        | (ValueVariants::Integer(_), FieldIndex::BooleanIndex(_))
        ...
        | (ValueVariants::String(_), FieldIndex::BooleanIndex(_))
...
fn get_match_any_checker(
    ...
    match (any_variant, index) {
        ...
        (AnyVariants::Integers(_), FieldIndex::BooleanIndex(_))
        ...
        | (AnyVariants::Strings(_), FieldIndex::BooleanIndex(_))
