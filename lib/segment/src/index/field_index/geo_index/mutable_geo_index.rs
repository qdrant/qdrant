...
impl GeoMapIndexRead for MutableGeoMapIndex {
    fn points_count(&self) -> usize {
        MutableGeoMapIndex::points_count(self)
    }

    fn points_values_count(&self) -> usize {
        MutableGeoMapIndex::points_values_count(self)
    }

    fn max_values_per_point(&self) -> usize {
        MutableGeoMapIndex::max_values_per_point(self)
    }
    ...
    fn points_of_hash(
        ...
        Ok(MutableGeoMapIndex::points_of_hash(self, hash))
    }
    ...
    fn values_of_hash(
        ...
        Ok(MutableGeoMapIndex::values_of_hash(self, hash))
    }
    ...
    fn check_values_any(
        ...
        MutableGeoMapIndex::check_values_any(self, idx, |p| check_fn(p))
    }

    fn values_count(&self, idx: PointOffsetType) -> usize {
        MutableGeoMapIndex::values_count(self, idx)
    }
    ...
    fn get_values(
        ...
        MutableGeoMapIndex::get_values(self, idx).map(|iter| {
    ...
    fn points_per_hash_filtered(
        ...
        Ok(MutableGeoMapIndex::points_per_hash(self)
            .filter(|pair| filter(pair))
            .collect())
    }

    fn get_storage_type(&self) -> StorageType {
        MutableGeoMapIndex::storage_type(self)
    }

    fn ram_usage_bytes(&self) -> usize {
        MutableGeoMapIndex::ram_usage_bytes(self)
    }
