...
use super::{
    DenseVectorStorage, MultiVectorStorage, SparseVectorStorage, VectorStorageElementType,
    VectorStorageEnum,
};
...
pub fn raw_scorer_impl<'a, TVectorStorage: DenseVectorStorage<VectorStorageElementType>>(
    query: QueryVector,
    vector_storage: &'a TVectorStorage,
    point_deleted: &'a BitSlice,
    is_stopped: &'a AtomicBool,
...
fn new_scorer_with_metric<
    'a,
    TMetric: Metric<VectorStorageElementType> + 'a,
    TVectorStorage: DenseVectorStorage<VectorStorageElementType>,
>(
    query: QueryVector,
    vector_storage: &'a TVectorStorage,
    point_deleted: &'a BitSlice,
