...
impl SegmentEntry for Segment {
    fn upsert_point(
        ...
        self.handle_point_version_and_failure_mut(op_num, stored_internal_point, |segment| {
    ...
    fn update_vectors(
        ...
        match internal_id {
            ...
            Some(internal_id) => {
                self.handle_point_version_and_failure_mut(op_num, Some(internal_id), |segment| {
    ...
    fn set_full_payload(
        ...
        let internal_id = self.id_tracker.borrow().internal_id(point_id);
        self.handle_point_version_and_failure_mut(
            op_num,
            internal_id,
