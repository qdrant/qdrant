...
pub fn build_segment_3(path: &Path) -> Segment {
    ...
    futures::executor::block_on(segment3.upsert_point(
        1,
        1.into(),
        collect_points_data(&vec1),
        &hw_counter,
    ))
    .unwrap();
    futures::executor::block_on(segment3.upsert_point(
    ...
    futures::executor::block_on(segment3.set_payload(
        6,
        1.into(),
        &payload_option1,
        &None,
