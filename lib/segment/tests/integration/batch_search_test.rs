...
fn test_batch_and_single_request_equivalency() {
    ...
    for _ in 0..10 {
        ...
        let search_res_1 = futures::executor::block_on(segment.search(
            DEFAULT_VECTOR_NAME,
            &query_vector_1,
            &WithPayload::default(),
            &false.into(),
        ...
        let search_res_2 = futures::executor::block_on(segment.search(
            DEFAULT_VECTOR_NAME,
            &query_vector_2,
            &WithPayload::default(),
            &false.into(),
        ...
        let batch_res = futures::executor::block_on(segment.search_batch(
            DEFAULT_VECTOR_NAME,
