...
/// A stored record turned into a point as an update carries it: the payload
/// blob is decoded, the way the gRPC boundary decodes it before a raw point
/// ever reaches an update.
