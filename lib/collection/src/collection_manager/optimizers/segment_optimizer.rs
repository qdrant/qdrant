...
pub trait SegmentOptimizer {
    ...
    fn temp_segment(&self, save_version: bool) -> CollectionResult<LockedSegment> {
        ...
        let config = SegmentConfig {
            vector_data: collection_params.to_base_vector_data(&quantization_config)?,
    ...
    fn optimized_segment_builder(
        ...
        let mut vector_data = collection_params.to_base_vector_data(&collection_quantization)?;
