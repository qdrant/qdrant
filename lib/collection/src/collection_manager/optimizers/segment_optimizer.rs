...
pub trait SegmentOptimizer {
    ...
    fn optimized_segment_builder(
        ...
        let is_indexed = total_vectors_size >= thresholds.indexing_threshold.saturating_mul(BYTES_IN_KB);

        let is_on_disk = total_vectors_size >= thresholds.memmap_threshold.saturating_mul(BYTES_IN_KB);
