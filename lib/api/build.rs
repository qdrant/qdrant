...
fn configure_validation(builder: Builder) -> Builder {
    builder
        ...
        .validates(&[
            ...
            ("PointStructList.points", ""),
            ("PointStructList.update_filter", ""),
            ("SetPayload.points_selector", ""),
            ("OverwritePayload.points_selector", ""),
            ("DeletePayload.points_selector", ""),
            ("UpdateVectors.points_selector", ""),
            ("DeleteVectors.points_selector", ""),
            ("ClearPayload.points", ""),
            ("PointsUpdateOperation.operation", ""),
            ("UpdateBatchPoints.operations", ""),
