...
fn configure_validation(builder: Builder) -> Builder {
    builder
        ...
        .validates(&[
            ...
            ("InternalSearchPoints.collection_name", "length(min = 1, max = 255)"),
            ("InternalSearchPoints.limit", "range(min = 1)"),
            ("InternalSearchPoints.params", ""),
            ("InternalSearchPoints.vector_name", "custom = \"crate::grpc::validate::validate_not_empty\""),
