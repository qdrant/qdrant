...
class Bm25Config:
    ...
    @property
    def stemmer(self, /) -> Incomplete | None: ...
    @property
    def stopwords(self, /) -> Incomplete | None: ...
    @property
...
@final
class ContextPair:
    def __new__(cls, /, positive: Incomplete, negative: Incomplete) -> ContextPair: ...
    def __repr__(self, /) -> str: ...
    @property
...
class ContextQuery:
    ...
    def __repr__(self, /) -> str: ...
    @property
    def pairs(self, /) -> list[Incomplete]: ...
...
class CountRequest:
    ...
    def exact(self, /) -> bool: ...
    @property
    def filter(self, /) -> Incomplete | None: ...
...
class DiscoverQuery:
    def __new__(
        cls, /, target: Incomplete, pairs: Sequence[ContextPair]
    ) -> DiscoverQuery: ...
    def __repr__(self, /) -> str: ...
    @property
    def pairs(self, /) -> list[Incomplete]: ...
...
class EdgeConfig:
    def __new__(
        ...
        quantization_config: Incomplete | None = None,
    ...
    @property
    def quantization_config(self, /) -> Incomplete | None: ...
    @property
...
class EdgeShard:
    ...
    def retrieve(
        self,
        /,
        point_ids: Sequence[Incomplete],
        with_payload: Incomplete | None,
        with_vector: Incomplete | None,
    ) -> list[Record]: ...
    def scroll(
        self, /, scroll: ScrollRequest
    ) -> tuple[list[Record], Incomplete | None]: ...
    def search(self, /, search: SearchRequest) -> list[ScoredPoint]: ...
    def snapshot_manifest(self, /) -> Incomplete: ...
    @staticmethod
    def unpack_snapshot(
...
class Expression:
    ...
    class Abs(Expression):
        ...
        def __new__(cls, /, expr: Incomplete) -> Expression.Abs: ...
        @property
        def expr(self, /) -> Incomplete: ...

    @final
    class Acosh(Expression):
        __match_args__: Final = ("expr",)
        def __new__(cls, /, expr: Incomplete) -> Expression.Acosh: ...
        @property
        def expr(self, /) -> Incomplete: ...
    ...
    class Condition(Expression):
        ...
        def __new__(cls, /, cond: Incomplete) -> Expression.Condition: ...
        @property
        def cond(self, /) -> Incomplete: ...
    ...
    class DatetimeKey(Expression):
        ...
        def __new__(cls, /, path: Incomplete) -> Expression.DatetimeKey: ...
        @property
    ...
    class Decay(Expression):
        ...
        @property
        def target(self, /) -> Incomplete | None: ...
        @property
    ...
    class Div(Expression):
        ...
        def __new__(
            cls, /, left: Incomplete, right: Incomplete, by_zero_default: float | None
        ) -> Expression.Div: ...
        @property
        def by_zero_default(self, /) -> float | None: ...
        @property
        def left(self, /) -> Incomplete: ...
        @property
        def right(self, /) -> Incomplete: ...

    @final
    class Exp(Expression):
        __match_args__: Final = ("expr",)
        def __new__(cls, /, expr: Incomplete) -> Expression.Exp: ...
        @property
        def expr(self, /) -> Incomplete: ...
    ...
    class GeoDistance(Expression):
        ...
        def __new__(
            cls, /, origin: GeoPoint, to: Incomplete
        ) -> Expression.GeoDistance: ...
        @property
        def origin(self, /) -> GeoPoint: ...
        @property
        def to(self, /) -> Incomplete: ...

    @final
    class Ln(Expression):
        __match_args__: Final = ("expr",)
        def __new__(cls, /, expr: Incomplete) -> Expression.Ln: ...
        @property
        def expr(self, /) -> Incomplete: ...
    ...
    class Log10(Expression):
        __match_args__: Final = ("expr",)
        def __new__(cls, /, expr: Incomplete) -> Expression.Log10: ...
        @property
        def expr(self, /) -> Incomplete: ...
    ...
    class Max(Expression):
        ...
        def __new__(cls, /, exprs: Sequence[Incomplete]) -> Expression.Max: ...
        @property
        def exprs(self, /) -> list[Incomplete]: ...

    @final
    class Min(Expression):
        __match_args__: Final = ("exprs",)
        def __new__(cls, /, exprs: Sequence[Incomplete]) -> Expression.Min: ...
        @property
        def exprs(self, /) -> list[Incomplete]: ...
    ...
    class Mult(Expression):
        __match_args__: Final = ("exprs",)
        def __new__(cls, /, exprs: Sequence[Incomplete]) -> Expression.Mult: ...
        @property
        def exprs(self, /) -> list[Incomplete]: ...
    ...
    class Neg(Expression):
        __match_args__: Final = ("expr",)
        def __new__(cls, /, expr: Incomplete) -> Expression.Neg: ...
        @property
        def expr(self, /) -> Incomplete: ...
    ...
    class Pow(Expression):
        ...
        def __new__(
            cls, /, base: Incomplete, exponent: Incomplete
        ) -> Expression.Pow: ...
        @property
        def base(self, /) -> Incomplete: ...
        @property
        def exponent(self, /) -> Incomplete: ...

    @final
    class Sqrt(Expression):
        __match_args__: Final = ("expr",)
        def __new__(cls, /, expr: Incomplete) -> Expression.Sqrt: ...
        @property
        def expr(self, /) -> Incomplete: ...
    ...
    class Sum(Expression):
        __match_args__: Final = ("exprs",)
        def __new__(cls, /, exprs: Sequence[Incomplete]) -> Expression.Sum: ...
        @property
        def exprs(self, /) -> list[Incomplete]: ...
...
@final
class FeedbackItem:
    def __new__(cls, /, vector: Incomplete, score: float) -> FeedbackItem: ...
    def __repr__(self, /) -> str: ...
    @property
    def score(self, /) -> float: ...
    @property
    def vector(self, /) -> Incomplete: ...
...
class FeedbackNaiveQuery:
    ...
    @property
    def feedback(self, /) -> list[Incomplete]: ...
    @property
    def target(self, /) -> Incomplete: ...
...
class FieldCondition:
    ...
    def key(self, /) -> Incomplete: ...
    @property
    def match(self, /) -> Incomplete | None: ...
    @property
...
class Filter:
    def __new__(
        cls,
        /,
        must: Sequence[Incomplete] | None = None,
        should: Sequence[Incomplete] | None = None,
        must_not: Sequence[Incomplete] | None = None,
    ...
    @property
    def must(self, /) -> list[Incomplete] | None: ...
    @property
    def must_not(self, /) -> list[Incomplete] | None: ...
    @property
    def should(self, /) -> list[Incomplete] | None: ...
...
class Formula:
    def __new__(
        cls, /, formula: Incomplete, defaults: dict[str, Incomplete] | None = None
    ) -> Formula: ...
    def __repr__(self, /) -> str: ...
...
class GeoPolygon:
    def __new__(
        cls, /, exterior: Incomplete, interiors: Sequence[Incomplete] | None = None
    ) -> GeoPolygon: ...
    def __repr__(self, /) -> str: ...
    @property
    def exterior(self, /) -> Incomplete: ...
    @property
    def interiors(self, /) -> list[Incomplete] | None: ...
...
class HasIdCondition:
    def __new__(cls, /, point_ids: set[Incomplete]) -> HasIdCondition: ...
    def __repr__(self, /) -> str: ...
    @property
    def point_ids(self, /) -> set[Incomplete]: ...
...
class IdfParams:
    ...
    def __repr__(self, /) -> str: ...
    @property
    def corpus(self, /) -> Incomplete | None: ...
...
class IsEmptyCondition:
    def __new__(cls, /, key: Incomplete) -> IsEmptyCondition: ...
    def __repr__(self, /) -> str: ...
    @property
    def key(self, /) -> Incomplete: ...
...
class IsNullCondition:
    def __new__(cls, /, key: Incomplete) -> IsNullCondition: ...
    def __repr__(self, /) -> str: ...
    @property
    def key(self, /) -> Incomplete: ...
...
@final
class MatchAny:
    def __new__(cls, /, any: Incomplete) -> MatchAny: ...
    def __repr__(self, /) -> str: ...
    @property
...
@final
class MatchExcept:
    def __new__(cls, /, value: Incomplete) -> MatchExcept: ...
    def __repr__(self, /) -> str: ...
    @property
    def value(self, /) -> Incomplete: ...
...
@final
class MatchValue:
    def __new__(cls, /, value: Incomplete) -> MatchValue: ...
    @property
    def value(self, /) -> Incomplete: ...
...
class MinShould:
    def __new__(
        cls, /, conditions: Sequence[Incomplete], min_count: int
    ) -> MinShould: ...
    def __repr__(self, /) -> str: ...
    @property
    def conditions(self, /) -> list[Incomplete]: ...
    @property
...
class NestedCondition:
    def __new__(cls, /, key: Incomplete, filter: Filter) -> NestedCondition: ...
    def __repr__(self, /) -> str: ...
    @property
    def filter(self, /) -> Incomplete: ...
    @property
    def key(self, /) -> Incomplete: ...
...
class OrderBy:
    def __new__(
        ...
        start_from: Incomplete | None = None,
    ) -> OrderBy: ...
    def __repr__(self, /) -> str: ...
    @property
    ...
    def key(self, /) -> Incomplete: ...
    @property
    def start_from(self, /) -> Incomplete | None: ...
...
class PayloadSelector:
    ...
    class Exclude(PayloadSelector):
        ...
        def __new__(cls, /, keys: Sequence[Incomplete]) -> PayloadSelector.Exclude: ...
        @property
    ...
    class Include(PayloadSelector):
        __match_args__: Final = ("keys",)
        def __new__(cls, /, keys: Sequence[Incomplete]) -> PayloadSelector.Include: ...
        @property
        def keys(self, /) -> list[Incomplete]: ...
...
class Point:
    def __new__(
        cls, /, id: Incomplete, vector: Incomplete, payload: Incomplete | None = None
    ) -> Point: ...
    def __repr__(self, /) -> str: ...
    @property
    def id(self, /) -> Incomplete: ...
    @property
    def payload(self, /) -> Incomplete | None: ...
    @property
    def vector(self, /) -> Incomplete: ...

@final
class PointVectors:
    def __new__(cls, /, id: Incomplete, vector: Incomplete) -> PointVectors: ...
    def __repr__(self, /) -> str: ...
    @property
    def id(self, /) -> Incomplete: ...
    @property
...
class Prefetch:
    ...
    @property
    def prefetches(self, /) -> list[Incomplete]: ...
    @property
    def query(self, /) -> Incomplete | None: ...
    @property
...
class Query:
    ...
    class Nearest(Query):
        __match_args__: Final = ("query", "using")
        def __new__(
            cls, /, query: Incomplete, using: str | None = None
        ) -> Query.Nearest: ...
        @property
        def query(self, /) -> Incomplete: ...
        @property
        def using(self, /) -> str | None: ...
...
class QueryRequest:
    def __new__(
        ...
        query: Incomplete | None = None,
        prefetches: Sequence[Prefetch] | None = None,
        with_vector: Incomplete | None = None,
        with_payload: Incomplete | None = None,
        filter: Filter | None = None,
        score_threshold: float | None = None,
        params: SearchParams | None = None,
    ) -> QueryRequest: ...
    ...
    def score_threshold(self, /) -> float | None: ...
    @property
    def with_payload(self, /) -> Incomplete: ...
    @property
    def with_vector(self, /) -> Incomplete: ...
...
class RecommendQuery:
    def __new__(
        cls, /, positives: Sequence[Incomplete], negatives: Sequence[Incomplete]
    ) -> RecommendQuery: ...
    def __repr__(self, /) -> str: ...
    @property
    def negatives(self, /) -> list[Incomplete]: ...
    @property
    def positives(self, /) -> list[Incomplete]: ...
...
class Record:
    ...
    def payload(self, /) -> Incomplete | None: ...
    @property
    def vector(self, /) -> Incomplete | None: ...
...
class ScrollRequest:
    ...
    @property
    def offset(self, /) -> Incomplete | None: ...
    @property
    def order_by(self, /) -> OrderBy | None: ...
    @property
    def with_payload(self, /) -> Incomplete | None: ...
    @property
    def with_vector(self, /) -> Incomplete: ...
...
class SearchRequest:
    ...
    def with_payload(self, /) -> Incomplete | None: ...
    @property
    def with_vector(self, /) -> Incomplete | None: ...
...
class UpdateOperation:
    @staticmethod
    def clear_payload(point_ids: Sequence[Incomplete]) -> UpdateOperation: ...
    @staticmethod
    ...
    def create_field_index(
        field_name: Incomplete, schema: Incomplete
    ) -> UpdateOperation: ...
    @staticmethod
    ...
    @staticmethod
    def delete_field_index(field_name: Incomplete) -> UpdateOperation: ...
    @staticmethod
    def delete_payload(
        point_ids: Sequence[Incomplete], keys: Sequence[Incomplete]
    ) -> UpdateOperation: ...
    @staticmethod
    def delete_payload_by_filter(
        filter: Filter, keys: Sequence[Incomplete]
    ) -> UpdateOperation: ...
    @staticmethod
    def delete_points(point_ids: Sequence[Incomplete]) -> UpdateOperation: ...
    @staticmethod
    ...
    @staticmethod
    def delete_vectors(
        point_ids: Sequence[Incomplete], vector_names: Sequence[str]
    ) -> UpdateOperation: ...
    @staticmethod
    ...
    def overwrite_payload_by_filter(
        filter: Filter, payload: Incomplete, key: Incomplete | None = None
    ) -> UpdateOperation: ...
    @staticmethod
    def set_payload(
        point_ids: Sequence[Incomplete],
