...
#[pyclass(name = "ScalarQuantizationConfig", skip_from_py_object)]
#[derive(Clone, Debug, Into, TransparentWrapper)]
#[repr(transparent)]
...
#[pyclass(name = "ScalarType", skip_from_py_object)]
...
#[pyclass(name = "ProductQuantizationConfig", skip_from_py_object)]
#[derive(Clone, Debug, Into, TransparentWrapper)]
#[repr(transparent)]
...
#[pyclass(name = "CompressionRatio", skip_from_py_object)]
#[derive(Copy, Clone, Debug)]
...
#[pyclass(name = "BinaryQuantizationConfig", skip_from_py_object)]
#[derive(Clone, Debug, Into, TransparentWrapper)]
#[repr(transparent)]
...
#[pyclass(name = "BinaryQuantizationEncoding", skip_from_py_object)]
#[derive(Copy, Clone, Debug)]
...
#[pyclass(name = "BinaryQuantizationQueryEncoding", skip_from_py_object)]
#[derive(Copy, Clone, Debug)]
