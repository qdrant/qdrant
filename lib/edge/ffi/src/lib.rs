...
//! construction in [`update`]. Shared value types, filters, config, and the
//! boundary error type live in [`types`], [`filter`], [`config`], and
//! [`error`]. The crate root re-exports the whole public surface.
