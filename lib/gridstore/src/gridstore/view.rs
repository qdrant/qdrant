...
use common::universal_io::StorageRead;
...
pub struct GridstoreView<'a, V, S: StorageRead<u8>> {
...
impl<'a, V, S: StorageRead<u8>> GridstoreView<'a, V, S> {
    pub(crate) fn new(
...
impl<'a, V: Blob, S: StorageRead<u8>> GridstoreView<'a, V, S> {
