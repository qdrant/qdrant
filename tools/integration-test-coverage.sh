...
uv run bash ./tests/integration-tests.sh # generates qdrant-openapi-*.profraw files
uv run bash ./tests/integration-tests.sh distributed # generates qdrant-openapi-*.profraw files
uv run pytest tests/consensus_tests --durations=10 # generates qdrant-consensus-tests-*.profraw files
